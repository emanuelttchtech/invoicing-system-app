...
<body>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container">
        <div class="row">
        <div class="col-lg-6">
            <p>Please check your email to find the code</p>
            <div class="background">
          <div class="form-setup col-lg-12">
          <form>
            <div class="form-group">
              <label for="exampleInputEmail1">Confirmation Code</label>
              <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Confirmation code">
        ...
        <div class="col-lg-6">
            <div class="top-logo">
                <img src="assets/img/ttch.png" alt="Image">
            </div>
