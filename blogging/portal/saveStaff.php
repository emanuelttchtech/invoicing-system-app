...
$query->execute();
	...
	$headers = "From:noreply@iehlongwane.co.za\r\n";
        ...
        $message .= '<h4>You have been successfully registered at Talent Trek, use your email and temporary password : '.$pass.' to login.</h4>';
        
        $message .= "<h5>www.iehlongwane.co.za.</h5><br/>";
