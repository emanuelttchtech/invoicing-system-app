                        ...
                        <div class="card mg-b-20">
                           <div class="card-header">
                              ...
                              <div class="col-lg-12">
                               ...
                               <div class="row">
                            <div class="col-lg-12">
                                 <label class="form-control-label" for="insight_meta_title">Meta title</label>
                                    <input id="insight_meta_title" type="text" name="meta_title" value="<?php echo $metaTitle ?>" class="form-control" placeholder="Enter Meta Title">
                              </div>
                               <div class="col-lg-12">
                                 <label class="form-control-label" for="insight_meta_desc">Meta Description</label>
                                    <input id="insight_meta_desc" type="text" name="meta_desc" value="<?php echo $metaDesc ?>" class="form-control" placeholder="Enter Meta Description">
                              </div>
                                 <div class="col-lg-12">
