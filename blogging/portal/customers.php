               ...
               <div id="main-wrapper">
                  ...
                  <div class="pageheader pd-t-25 pd-b-35">
                     <div class="pd-t-5 pd-b-5">
                        <h1 class="pd-0 mg-0 tx-20">Customers</h1>
                     </div>
                  ...
                  <div class="row row-xs clearfix">
                     ...
                     <div class="col-lg-3" style="margin-bottom: 10px">
                      <a href="add-insight" class="btn btn-primary"> Add Customer</a>
                   </div>
                        ...
                        <div class="card mg-b-20">
                           ...
                           <div class="card-body pd-0 collapse show" id="studentDetails">
                              ...
                              <table id="scrollableTable" class="table hover responsive display nowrap">
                                    ...
                                    <tbody>
                                       <?php 
                                          $query = $web->getAllCustomers();
                                          for($i = 0; $rows = $query->fetch();$i++)
                                          {
                                            $web->getCustomerDataById($rows['customer_id']);
                                            ?>
                                       <tr class="record">
                                          
                                       
                                          <td><?php echo $web->getNamee()?></td>
                                          <td><?php echo $web->getCustomerEmail() ?></td>
                                          <td><?php echo $web->getPhoneNumber() ?></td> 
                                          <td><?php echo $web->getNotes() ?></td>
                                          <td><?php echo $web->getCustomerLogo() ?></td>
                                          <td><?php echo $web->getDomain() ?></td> 
                                          <td><?php echo $web->getFavicon() ?></td> 
                                          <td><?php echo $web->getCategory() ?></td> 
                                          <td><?php echo $web->getComapny_profile() ?></td> 
                                          <td><?php echo $web->getContent() ?></td>
                                          <td><?php echo $web->getImage_gallary() ?></td>
                                          <td><?php echo $web->getAdv_seo() ?></td>
                                          <td><?php echo $web->getExtra_disk() ?></td>
                                          <td><?php echo $web->getExtra_pages() ?></td>
                                          <td><?php echo $web->getDates() ?></td>
