  <!-- The above 6 meta tags *must* come first in the head; any other head content must come *after* these tags -->
      ...
      <title>TTCH Technologies</title>
  <meta name="contact" content="www.ttchtech.co.za/index#contact">
  <meta name="copyright" content="TTCH Technologies 2024">
    <meta content="TTCH is a Technology house consisting of multiple innovative structures, some of our services include Software Development, Project Management, Technical Support, Implementations & Training" name="description">
    <meta name="keywords" content="Technology, IT Services, IT, Development, Dev, App Dev, Web Development, Mobile Development, System Installations & Support, ICT Training, Network Installation & Maintenance, ICT Project Management">
      ...
      <link type="text/css" rel="stylesheet" href="assets/summernote/summernote.min.css">
      ...
      <!-- Favicon -->	
      <link rel="icon" href="assets/images/TTCH-Technologies.png" type="image/x-icon">
      <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script>
       <script src="assets/src/facebox.js" type="text/javascript"></script>
