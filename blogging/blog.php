...
include 'portal/assets/classes/functions.php';  
    ...
    <div class="container d-flex justify-content-between">
      ...
      <nav id="navbar" class="navbar text-center">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="#">Blogs</a></li>
  ...
  <section class="blog-info d-flex align-items-center">
    <div class="container">
      <div class="blog-intro">
        <div class="blog-img">
          <img src="admin/img/<?php echo $img ?>">
        </div>
        <div class="authors-info">
            ...
            <div class="d-flex justify-content-between">
              <div class="">
                ...
                <p>Software Developer, Author</p>
              </div>
            </div>
            <label class="blog-date">13/12/2023</label>
          </div>
      </div>        
     ...
     <section id="blogs" class="blogs section-bg">
      <div class="container" data-aos="fade-up">
        <div class="section-title">
          <h2>Other blogs</h2>
          <p class="text-white">We are always ready for a challenge.</p>
        </div>
        <div class="row">
          <div class="col-xl-4 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="blog-box">
              <div class="author"><img src="assets/img/team/team-1.jpg"></div>
              <hr>
              <h4><a href="https://wa.me/+27762538318/?text=System%20Installations%20&%20Support">Importance of AI</a></h4>
              <p>We install system and applications to your computers and mobile devices and provide support <a href="https://wa.me/+27762538318/?text=System%20Installations%20&%20Support" class="">More...</a></p>
              <p class="blog-details">By Innocent Hlongwane<br>02/02/2024</p>              
            </div>
          </div> 
